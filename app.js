...
var Hello = React.createClass({displayName: "Hello",
  render: function(){
      return (
          React.createElement("li", null, React.createElement("p", {className: "red"},  this.props.text)) 
      );        
  }
});
...
var Input = React.createClass({displayName: "Input",
  ...
  render: function(){
      return (
        React.createElement("input", {ref: "filterTextInput", value: this.props.filterText, onChange: this.handleChange})  
      );        
  }
});
...
var List = React.createClass({displayName: "List",
  render: function(){
    ...
    var rows = this.props.hellos
        ...
        .map(function(hello){
        return React.createElement(Hello, {key: hello.id, text: hello.text})
    });
  ...
  render: function(){
    return (
        React.createElement("div", null, 
          React.createElement(Input, {onFilterInput: this.handleFilterInput, filterText: this.state.filterText}), 
          React.createElement(List, {filterText: this.state.filterText, hellos: this.props.data})
        )
    )        
  }
});

React.render(React.createElement(Main, {data: data}), document.getElementById('hello'));


},{"./hello":2,"react":149}],4:[function(require,module,exports){
/**
